...
data <- data.frame(population=c(rep(256,length(data.256$Time)),
                                 rep(512,length(data.512$Time)),
                                 rep(1024,length(data.1024$Time))),
                   time=c(data.256$Time,data.512$Time,data.1024$Time),
                   evaluations=c(data.256$Evaluations,data.512$Generations,data.1024$Generations))
