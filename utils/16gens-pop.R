...
data.128 <- read.csv('../data/16gens-128pop.csv')
data.256 <- read.csv('../data/16generations.csv')
data.512 <- read.csv('../data/16gens-512pop.csv')

data <- data.frame(population=c(rep(128,length(data.128$Time)),
                                rep(256,length(data.256$Time)),
                                rep(512,length(data.512$Time))),
                   time=c(data.128$Time,data.256$Time,data.512$Time),
                   evaluations=c(data.128$Generations,data.256$Generations,data.512$Generations))
