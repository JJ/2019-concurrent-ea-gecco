...
ggplot(data.freqs.ap.threads,aes(x=Threads,y=Evaluations,group=Threads))+geom_boxplot()+theme_tufte()+scale_x_continuous(name="Threads",breaks=c(2,4,6,8))+labs(x="Threads",y="Evaluations",title="Adaptive population")
